...
{
    public class PetshopRepository : IOriginRepository
    {
        private readonly Logger _logger;
        private readonly string _connString = "Host=127.0.0.1;Port=5434;Username=postgres;Password=123;Database=tbl_petshop_ecommerce_2025_postgresql;Pooling=true";

        public string Name => "tbl_petshop_ecommerce_2025_postgresql";

        public PetshopRepository(Logger logger)
        {
            _logger = logger;
        }
        ...
        public IEnumerable<List<ProdutoImportacao>> GetBatches(int batchSize)
        {
            ...
            {
                conn.Open();
                string sql = "SELECT gtin, nome, marca, departamento, categoria, sub_categoria, sub_categoria_2, ncm, foto_jpg, foto_webp, foto_jpg580 FROM public.tbl_petshop_ecommerce_2025";
